...
<head>
    <title>{{ config('app.name', 'Laravel') }} | Secretary</title>
...
<body class="overflow-hidden vh-100" id="secretaryPage">
    @include('template.navbar')

    <div class="d-flex gap-1 h-100 p-2 bg-secondary-subtle">
        <!-- Left Column -->
        <div class="h-100" style="min-width: 45rem;">
            <div class="m-0 pb-5 h-100 d-flex flex-column gap-1 overflow-auto">
                            ...
                            <div class="d-flex gap-2">
                                <div class="w-50">
                                    <div class="d-flex input-group">
                                        ...
                                        <input class="form-control form-control-sm" type="date" name="queuedate" id="queuedate" value="{{ now()->toDateString() }}">
                            ...
                            <table class="table table-sm table-bordered table-hover" id="patients_queue_table">
                                <thead class="table-success">
                                    <tr>
                                        ...
                                        <th scope="col">Patient Name <span class="text-secondary">(First, Middle, Last, Suffix)</span></th>
                        ...
                        <div class="d-flex gap-3">
                            <div class="d-flex flex-column gap-2 w-100">
                                <div class="d-flex flex-column gap-0 ms-1">
                                    <p class="text-secondary m-0"><span class="fw-bold">Consultation Reference #:</span> <span id="pxconsultationrefno"></span></p>
                                    <p class="text-secondary m-0"><span class="fw-bold">Patient ID:</span> <span id="pxidno"></span></p>
                                </div>
                                ...
                                <fieldset class="gap-1" readonly>
                                    <div class="d-flex">
                                        <div class="p-1">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="pxfname" id="pxfname">
                                        </div>

                                        <div class="p-1">
                                            <label class="form-label fw-bold m-0" for="pxmname">Middle Name</label>
                                            <input type="text" class="form-control form-control-sm" name="pxmname" id="pxmname">
                                        </div>

                                        <div class="p-1">
                                            <label class="form-label fw-bold m-0" for="pxlname">Last Name</label>
                                            <input type="text" class="form-control form-control-sm" name="pxlname" id="pxlname">
                                        </div>

                                        <div class="p-1" style="max-width: 5rem;">
                                            <label class="form-label fw-bold m-0" for="pxsuffix">Suffix</label>
                                            <input type="text" class="form-control form-control-sm" name="pxsuffix" id="pxsuffix">
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="p-1">
                                            ...
                                            <input type="date" class="form-control form-control-sm" name="pxbday" id="pxbday">
                                        </div>
                                        ...
                                        <div class="p-1">
                                            ...
                                            <input type="tel" class="form-control form-control-sm" name="pxcellnumber" id="pxcellnumber">
                                        </div>

                                        <div class="p-1">
                                            <label class="form-label fw-bold m-0" for="pxlandlinenumber">Landline No.</label>
                                            <input type="tel" class="form-control form-control-sm" name="pxlandlinenumber" id="pxlandlinenumber">
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="p-1">
                                            ...
                                            <input type="email" class="form-control form-control-sm" name="pxemail" id="pxemail">
                                        </div>

                                        <div class="p-1 w-100">
                                            <label class="form-label fw-bold m-0" for="pxaddress">Address</label>
                                            <input type="text" class="form-control form-control-sm" name="pxaddress" id="pxaddress">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="d-flex flex-column gap-1 mb-1 mt-auto">
                                <img class="border border-secondary" style="max-height: 12rem; min-height: 12rem; max-width: 12rem; min-width: 12rem;" src="{{ asset('images/blank_photo.png') }}" alt="patient-image" id="patient_picture_preview">
                                <div class="input-group justify-content-center">
                                    <input type="hidden" name="photo_path" id="photo_path">
                                    <button type="button" class="btn btn-sm btn-primary text-nowrap fw-bold" id="upload_patient_image">
                        ...
                        <div>
                            <ul class="nav nav-tabs nav-fill" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button type="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#consul_info" role="tab" aria-controls="consul_info" aria-selected="true">
                                        Consultation Details
                                    </button>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#payment_info" role="tab" aria-controls="payment_info" aria-selected="false" id="patient_charges_btn">
                                        Payment Details
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content border border-top-0 rounded-bottom p-3 d-flex flex-column flex-grow-1">
                                <div class="tab-pane active" id="consul_info" role="tabpanel">
                                    <div class="d-flex align-items-end gap-1">
                                        <div>
                                            <label class="form-label fw-bold m-0" for="doctor_for_consult">Assign Doctor</label>
                                            <select class="form-select form-select-sm" name="doctor_for_consult" id="doctor_for_consult" required>
                                                @foreach ($doctors as $doctor)
                                        ...
                                        <div class="d-flex flex-column ms-auto">
                                            <div class="input-group">
                                                <input type="date" class="form-control form-control-sm" name="sched_date" id="sched_date">
                                                <select class="form-select form-select-sm" name="sched_time" id="sched_time"></select>
                                            </div>
                                    ...
                                    <div class="d-flex flex-column gap-2 mt-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="w-100">
                                                <label class="form-label fw-bold m-0" for="reason_for_consultation">Chief Complaints</label>
                                                <textarea class="form-control form-control-sm" rows="4" name="reason_for_consultation" id="pxreasonforconsultation"></textarea>
                                            </div>
                                            ...
                                            <div class="d-flex flex-column gap-2" style="min-width: 12.5rem;">
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control form-control-sm" style="max-width: 7.5rem;" min="0.00" value="0.00" name="weight" id="pxweight">
                                                        <select class="form-select form-select-sm" style="max-width: 5rem;" name="w_unit" id="pxweight_unit">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control form-control-sm" style="max-width: 7.5rem;" min="0.00" value="0.00" name="height" id="pxheight">
                                                        <select class="form-select form-select-sm" style="max-width: 5rem;" name="h_unit" id="pxheight_unit">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div>
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control form-control-sm" style="max-width: 7.5rem;" min="0.00" value="0.00" name="temperature" id="pxtemp">
                                                    <select class="form-select form-select-sm" style="max-width: 5rem;" name="t_unit" id="pxtemp_unit">
                                            ...
                                            <div>
                                                <label class="form-label fw-bold m-0" for="respiratory_rate">Respiratory Rate</label>
                                                <input type="number" class="form-control form-control-sm" min="0.00" value="0.00" name="respiratory_rate" id="pxrespiratory">
                                            </div>

                                            <div>
                                                <label class="form-label fw-bold m-0" for="pulse_rate">Pulse Rate</label>
                                                <input type="number" class="form-control form-control-sm" min="0.00" value="0.00" name="pulse_rate" id="pxpulse">
                                            </div>

                                            <div>
                                                <label class="form-label fw-bold m-0" for="pulse_rate">Blood Pressure</label>
                                                <div class="input-group">
                                                    <input type="number" class="form-control form-control-sm" min="0.00" placeholder="Systolic" name="bp_numerator" id="pxbpnumerator">
                                                    <input type="number" class="form-control form-control-sm" min="0.00" placeholder="Diastolic" name="bp_denominator" id="pxbpdenominator">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="w-50">
                                                <label class="form-label fw-bold m-0" for="preview_radiology">Radiology Result</label>
                                                <div class="input-group">
                                                    <input type="file" class="form-control form-control-sm" name="radiologypath" id="radiologypath">
                                                    <button type="button" class="btn btn-sm btn-primary" id="preview_radiology">
                                            ...
                                            <div class="w-50">
                                                <label class="form-label fw-bold m-0" for="preview_laboratory">Laboratory Result</label>
                                                <div class="input-group">
                                                    <input type="file" class="form-control form-control-sm" name="laboratorypath" id="laboratorypath">
                                                    <button type="button" class="btn btn-sm btn-primary" id="preview_laboratory">
                                                        <i class="fa-solid fa-eye"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="button" class="btn btn-sm btn-warning fw-bold text-white update_consultation_btn">
                                ...
                                <div class="tab-pane" id="payment_info" role="tabpanel">
                                    <div class="d-flex flex-column gap-1">
                                        <div class="w-100 d-flex justify-content-end">
                                            <button type="button" class="btn btn-sm btn-warning text-white fw-bold" id="append_pxcharges_btn">
