...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_lipidprofile', function (Blueprint $table) {
            ...
            $table->text('dReferralFacility')->nullable()->comment('Name of Referral Facility, if referred 1000');
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for Lipid Profile ');
            $table->string('dLdl', 50)->nullable()->comment('Value for LDL (mg/dL)');
            $table->string('dHdl', 50)->nullable()->comment('Value for HDL (mg/dL)');
            $table->string('dTotal', 50)->nullable()->comment('Total Value of Cholesterol (mg/dL)');
            $table->string('dCholesterol', 50)->nullable()->comment('Total Value of Cholesterol (mg/dL)');
            $table->string('dTriglycerides', 50)->nullable()->comment('Total Value of Triglycerides (mg/dL)');
    ...
    {
        Schema::dropIfExists('dd_diag_lipidprofile');
    }
};
