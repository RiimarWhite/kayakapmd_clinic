...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_chestxray_findings', function (Blueprint $table) {
            $table->string('finding_id', 3)->nullable()->comment('FINDINGS DESCRIPTION ID');
            $table->string('finding_desc', 100)->nullable()->comment('FINDINGS DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_chestxray_findings');
    }
};
