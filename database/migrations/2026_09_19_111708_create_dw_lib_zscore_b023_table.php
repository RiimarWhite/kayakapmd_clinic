...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_zscore_b023', function (Blueprint $table) {
            $table->string('LIB_CODE', 4)->nullable()->comment('Library Code');
            $table->string('LENGTH', 10)->nullable()->comment('BOY LENGTH IN CM');
            $table->string('WEIGHT', 10)->nullable()->comment('BOY WEIGHT IN KG');
    ...
    {
        Schema::dropIfExists('dw_lib_zscore_b023');
    }
};
