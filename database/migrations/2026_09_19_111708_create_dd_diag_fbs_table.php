...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_fbs', function (Blueprint $table) {
            ...
            $table->string('dReferralFacility', 2000)->nullable()->comment('Name of Referral Facility, if referred 1000');
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for FBS ');
            $table->string('dGlucoseMg', 50)->nullable()->comment('Value for Glucose in md/Dl');
            $table->string('dGlucoseMmol', 50)->nullable()->comment('Value for Glucose in mmol/L');
    ...
    {
        Schema::dropIfExists('dd_diag_fbs');
    }
};
