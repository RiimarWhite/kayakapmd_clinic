...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_immelderly', function (Blueprint $table) {
            $table->string('immcode', 3)->nullable()->comment('HEART DESCRIPTION ID');
            $table->string('imm_desc', 100)->nullable()->comment('HEART_DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_immelderly');
    }
};
