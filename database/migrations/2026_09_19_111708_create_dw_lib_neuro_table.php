...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_neuro', function (Blueprint $table) {
            $table->string('neuro_id', 3)->nullable()->comment('NEURO DESCRIPTION ID');
            $table->string('neuro_desc', 100)->nullable()->comment('NEURO DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_neuro');
    }
};
