...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_profile_medhist', function (Blueprint $table) {
            ...
            $table->enum('dReportStatus', ['V', 'U', 'F'])->nullable()->comment('Verified Unvalidated Failed');
    ...
    {
        Schema::dropIfExists('dd_profile_medhist');
    }
};
