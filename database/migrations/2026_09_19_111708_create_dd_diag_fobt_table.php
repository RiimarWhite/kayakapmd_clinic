...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_fobt', function (Blueprint $table) {
            ...
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for FOBT ');
    ...
    {
        Schema::dropIfExists('dd_diag_fobt');
    }
};
