...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_papsmear', function (Blueprint $table) {
            ...
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for PAPSMEAR ');
            $table->string('dFindings', 500)->nullable();
            $table->string('dImpression', 500)->nullable();
    ...
    {
        Schema::dropIfExists('dd_diag_papsmear');
    }
};
