...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_ppdtest', function (Blueprint $table) {
            ...
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for creatine ');
            $table->enum('dFindings', ['P', 'N'])->nullable()->comment('P - Positive;
                            N - Negative ');
    ...
    {
        Schema::dropIfExists('dd_diag_ppdtest');
    }
};
