...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_rbs', function (Blueprint $table) {
            ...
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for RBS ');
    ...
    {
        Schema::dropIfExists('dd_diag_rbs');
    }
};
