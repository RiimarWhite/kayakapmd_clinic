...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_signs_symptoms', function (Blueprint $table) {
            $table->string('symptoms_id', 3)->nullable()->comment('Signs and Symptoms ID');
            $table->string('symptoms_desc', 100)->nullable()->comment('Signs and Symptoms description');
    ...
    {
        Schema::dropIfExists('dw_lib_signs_symptoms');
    }
};
