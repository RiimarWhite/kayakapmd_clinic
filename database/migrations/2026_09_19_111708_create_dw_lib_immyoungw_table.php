...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_immyoungw', function (Blueprint $table) {
            $table->string('imm_code', 3)->nullable()->comment('HEART DESCRIPTION ID');
    ...
    {
        Schema::dropIfExists('dw_lib_immyoungw');
    }
};
