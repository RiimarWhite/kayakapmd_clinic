...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_icd', function (Blueprint $table) {
            $table->bigInteger('refcode')->nullable();
            $table->string('icd_code', 10)->nullable()->comment('ICD 10 CODE');
            $table->string('icd_desc', 500)->nullable();
    ...
    {
        Schema::dropIfExists('dw_lib_icd');
    }
};
