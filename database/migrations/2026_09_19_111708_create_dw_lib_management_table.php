...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_management', function (Blueprint $table) {
            $table->string('management_id', 3)->nullable()->comment('PLAN MANAGEMENT CODE');
            $table->string('manadement_desc', 100)->nullable()->comment('PLAN MANAGEMENT DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_management');
    }
};
