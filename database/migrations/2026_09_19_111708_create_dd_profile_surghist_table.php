...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_profile_surghist', function (Blueprint $table) {
            ...
            $table->string('dSurgDesc', 500)->nullable();
            $table->date('dSurgDate')->nullable();
    ...
    {
        Schema::dropIfExists('dd_profile_surghist');
    }
};
