...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_ecg', function (Blueprint $table) {
            ...
            $table->date('dLabDate')->nullable()->comment('YYYY-MM-DD, Date of Laboratory for ECG ');
            $table->enum('dFindings', ['1', '2'])->nullable()->comment('1 - Awake and Alert, 2 - Altered Sensorium');
            $table->string('dRemarks', 1000)->nullable();
    ...
    {
        Schema::dropIfExists('dd_diag_ecg');
    }
};
