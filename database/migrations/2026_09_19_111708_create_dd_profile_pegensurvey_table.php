...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_profile_pegensurvey', function (Blueprint $table) {
            ...
            $table->enum('dGenSurveyId', ['1', '2', ''])->nullable()->comment('1 - Awake and Alert, 2 - Altered Sensorium');
            $table->string('dGenSurveyRem', 2000)->nullable();
    ...
    {
        Schema::dropIfExists('dd_profile_pegensurvey');
    }
};
