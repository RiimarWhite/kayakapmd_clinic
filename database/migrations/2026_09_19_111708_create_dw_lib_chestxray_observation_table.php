...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_chestxray_observation', function (Blueprint $table) {
            $table->string('observe_id', 3)->nullable()->comment('OBSERVATION DESCRIPTION ID');
            $table->string('observe_desc', 100)->nullable()->comment('CHEST DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_chestxray_observation');
    }
};
