...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_heart', function (Blueprint $table) {
            $table->string('heart_id', 3)->nullable()->comment('HEART DESCRIPTION ID');
            $table->string('heart_desc', 100)->nullable()->comment('HEART DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_heart');
    }
};
