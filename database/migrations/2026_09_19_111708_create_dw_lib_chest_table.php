...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_chest', function (Blueprint $table) {
            $table->string('chest_id', 3)->nullable()->comment('CHEST DESCRIPTION ID');
            $table->string('chest_desc', 100)->nullable()->comment('CHEST DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_chest');
    }
};
