...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_skin_extremities', function (Blueprint $table) {
            $table->string('skin_id', 3)->nullable()->comment('SKIN/EXTREMITIES DESCRIPTION ID');
            $table->string('skin_desc', 100)->nullable()->comment('SKIN/EXTREMITIES DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_skin_extremities');
    }
};
