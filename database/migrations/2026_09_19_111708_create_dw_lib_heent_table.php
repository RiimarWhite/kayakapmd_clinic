...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_heent', function (Blueprint $table) {
            $table->string('heent_id', 3)->nullable()->comment('HEENT DESCRIPTION ID');
            $table->string('heent_desc', 100)->nullable()->comment('HEENT_DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_heent');
    }
};
