...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_soap_icd', function (Blueprint $table) {
            ...
            $table->string('dIcdCode', 10)->nullable();
            $table->enum('dReportStatus', ['V', 'U', 'F'])->nullable();
            $table->text('dDeficiencyRemarks')->nullable();
            $table->integer('seq_no')->nullable()->comment('sequence of display in dianosis');
    ...
    {
        Schema::dropIfExists('dd_soap_icd');
    }
};
