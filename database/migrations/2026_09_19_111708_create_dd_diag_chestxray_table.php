...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_chestxray', function (Blueprint $table) {
            ...
            $table->string('dFindings', 3)->nullable();
            $table->string('dRemarksFindings', 2000)->nullable()->comment('2000');
            $table->string('dObservation', 100)->nullable();
            $table->string('dRemarksObservation', 2000)->nullable()->comment('2000');
    ...
    {
        Schema::dropIfExists('dd_diag_chestxray');
    }
};
