...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_genitourinary', function (Blueprint $table) {
            $table->string('gu_id', 3)->nullable()->comment('SKIN/EXTREMITIES DESCRIPTION ID');
            $table->string('gu_desc', 100)->nullable()->comment('SKIN/EXTREMITIES DESCRIPTION');
    ...
    {
        Schema::dropIfExists('dw_lib_genitourinary');
    }
};
