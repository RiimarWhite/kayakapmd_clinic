...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_profile_famhist', function (Blueprint $table) {
            ...
            $table->string('dMdiseaseCode', 3)->nullable();
            $table->enum('dReportStatus', ['V', 'U', 'F'])->nullable()->comment('Validated Unvalidated Failed');
    ...
    {
        Schema::dropIfExists('dd_profile_famhist');
    }
};
