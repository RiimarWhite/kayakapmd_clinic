...
return new class extends Migration
{
    ...
    {
        Schema::create('dd_diag_sputum', function (Blueprint $table) {
            ...
            $table->text('dReferralFacility')->nullable()->comment('1000');
            $table->date('dLabDate')->nullable();
            $table->enum('dDataCollection', ['1', '2', '3', 'X'])->nullable();
            $table->enum('dFindings', ['1', '2'])->nullable();
            $table->text('dRemarks')->nullable()->comment('2000');
            $table->string('dNoPlusses', 5)->nullable();
    ...
    {
        Schema::dropIfExists('dd_diag_sputum');
    }
};
