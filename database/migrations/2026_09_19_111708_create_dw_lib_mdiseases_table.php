...
return new class extends Migration
{
    ...
    {
        Schema::create('dw_lib_mdiseases', function (Blueprint $table) {
            $table->string('mdisease_code', 3)->nullable()->comment('Medical disease ID');
            $table->string('mdisease_desc', 150)->nullable()->comment('Medical disease description');
    ...
    {
        Schema::dropIfExists('dw_lib_mdiseases');
    }
};
